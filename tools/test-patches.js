...
const REQUIRED = {
  all: [
    ...
    ['refonte mobile : feuille de style', 'notesfrais-mobile-redesign-v1'],
    ['refonte mobile : feuille de capture', 'data-nfm-capture'],
    ['refonte mobile : recapitulatif du mois', 'nfm-sum-total'],
    ['refonte mobile : enchainer une saisie', 'confirm(true)'],
    ['refonte mobile : recouvrements portes sur body', 'document.body)'],
